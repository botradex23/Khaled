...
// Create a test module for testing the stop-loss/take-profit functionality
// This file is in CommonJS format since we can run it directly with Node.js
...
async function testTakeProfitScenario(symbol, initialPrice, positionId) {
  ...
  // Wait a bit for risk manager to process
  await sleep(2000);
