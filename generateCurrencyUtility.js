...
// Usage examples
// The examples below are for documentation purposes and are not executed in the utility module itself.

// Formatting currency:
console.log(formatCurrency(1234.56));             // "$1,234.56" (Default: USD, en-US)
console.log(formatCurrency(1234.56, 'EUR', 'de-DE')); // "1.234,56 €" (German locale with Euro)
console.log(formatCurrency(1234.56, 'JPY', 'ja-JP')); // "￥1,235" (Japanese locale with Yen)

// Parsing currency:
console.log(parseCurrency('$1,234.56'));           // 1234.56
console.log(parseCurrency('1.234,56 €', 'de-DE')); // 1234.56
console.log(parseCurrency('￥1,235', 'ja-JP'));    // 1235