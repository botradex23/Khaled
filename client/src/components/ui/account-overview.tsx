    ...
    return (
      <Card>
        <CardHeader>
          ...
          <CardDescription>Error loading account data</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="bg-muted p-4 rounded-lg flex items-center gap-2">
            <BadgeInfo className="h-5 w-5 text-muted-foreground" />
            <span className="text-sm">
              {error ? "Failed to load account data" : "No account data available"}
            </span>
          </div>
          <p className="text-sm text-muted-foreground mt-4">
            This could be due to API key permissions or connection issues. Please check your API settings.
          </p>
        </CardContent>
      </Card>
    );
      ...
      <CardContent className="space-y-4">
        {error ? (
          <div className="bg-muted p-4 rounded-lg">
            <p className="text-sm">Unable to load trading history</p>
          </div>
