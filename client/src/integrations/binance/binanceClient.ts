/**
 * Binance REST API Client Module
 * Provides functions for interacting with the Binance REST API
 */
 ...
 */
export const binanceService = new BinanceApiService(getDefaultBinanceConfig());